...
class Cart extends Component {
    ...
    //         first_name: this.state.customer.firstName || "Guest",
    //         last_name: this.state.customer.lastName || "",
    //         email: this.state.customer.email || "guest@example.com",
    //         phone: this.state.customer.phone || "081000000000",
    //     };
    
    //     // Parameter transaksi
    //     let parameter = {
    //         transaction_details: {
    //             order_id: `ORDER-${Date.now()}`, // Pastikan ID unik
    ...
    //     // Membuat transaksi melalui Snap API
    //     snap.createTransaction(parameter)
    //         .then((transaction) => {
    //             const transactionToken = transaction.token;
    
    //             // Menampilkan dialog Snap untuk menyelesaikan pembayaran
    //             Swal.fire({
    //                 title: this.state.translations["confirm_pay"],
    //                 html: `<button id="pay-button" class="swal2-confirm swal2-styled">
    //                         ${this.state.translations["pay_now"]}
    //                        </button>`,
    //                 showCancelButton: true,
    //                 cancelButtonText: this.state.translations["cancel_pay"],
    //                 didOpen: () => {
    //                     // Menginisialisasi Snap Pop-up
    //                     const payButton = Swal.getPopup().querySelector('#pay-button');
    //                     payButton.addEventListener('click', () => {
    //                         window.snap.pay(transactionToken, {
    //                             onSuccess: (result) => {
    //                                 Swal.fire('Payment Success', 'Transaction ID: ' + result.transaction_id, 'success');
    //                                 this.loadCart(); // Reset keranjang setelah pembayaran berhasil
    //                             },
    //                             onPending: (result) => {
    //                                 Swal.fire('Payment Pending', 'Please complete your payment.', 'info');
    //                             },
    //                             onError: (result) => {
    //                                 Swal.fire('Payment Failed', 'Error: ' + result.status_message, 'error');
    //                             },
    //                             onClose: () => {
    //                                 console.log('Customer closed the pop-up.');
    //                             },
    //                         });
    //                     });
    //                 },
    ...
    //             Swal.fire('Error', 'Failed to create transaction. Please try again later.', 'error');
    //         });
    // }
